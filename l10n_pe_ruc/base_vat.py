            ...
            if len(vat)>3:
                ...
                if vat_type and vat_type.upper() == 'PED':
                    ...
                    if len(vat) != 14:
                        ...
                        raise UserError(_(vat+" El RUC incorrecto"))
                    vat = vat[3:14]
                    ...
                    try:
                        ...
                        raise UserError(_(vat+' El RUC debe contener solo numeros enteros'))         
                    for f in range(0,10):
                    ...
                    if int(vat[10]) == dig_check:
                        ...
                        if(captcha_val.isalpha()):
                            ...
                            if texto_error in (texto_consulta):
                                ...
                                raise UserError(_('Consulte nuevamente'))
                            else:
                                #consulta(ruc)
                            ...
                            raise UserError(_('Ruc captcha no reconocido intente nuevamente'))
                    else:
                        #raise osv.except_osv(
                        #    _('Error'),
                        #    _(vat+"El RUC ingresado no es correcto"))
                        raise UserError(_(vat+" El RUC ingresado no es correcto"))
