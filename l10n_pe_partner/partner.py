...
class res_partner(models.Model):
    ...
    @api.multi
    def _type_doc(self):
        doc = [('1','DOCUMENTO NACIONAL DE IDENTIDAD (DNI)'),
    ...
    def on_change_company_type(self, company_type):
        if company_type == 'company':            
            return {'value': {'is_company': company_type == 'company', 'doc_type': '6'}}   
        else:
            return {'value': {'is_company': company_type == 'person', 'doc_type': '1'}}  